...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ad4msjuli@gmail.com",
    href: "mailto:ad4msjuli@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/noah-adam-benrabah-ab0325383/",
    content: "/noah-adam-benrabah",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/ad4mjulie",
    content: "/ad4mjulie",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Adam Noah</p>
                <div className="text-xs bg-zinc-700 w-fit px-3 py-1 rounded-full">
                  Network Sec Internship
                </div>
              </div>
            </div>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Adam Noah, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and
