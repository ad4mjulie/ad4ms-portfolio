  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (activeSection === "hero") {
        ...
        // Make keyboard completely still on skills page
        rotateKeyboard.pause();
        teardownKeyboard.pause();
        // Set to a fixed rotation for skills section
        gsap.to(kbd.rotation, {
          y: keyboardStates("skills").rotation.y,
          x: keyboardStates("skills").rotation.x,
          z: keyboardStates("skills").rotation.z,
          duration: 0.5,
          ease: "power2.out",
        });
