...
const projects: Project[] = [
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/blackhole/landing.png",
    screenshots: ["landing.png"],
    live: "https://ad4mjulie.github.io/black-hole/",
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/cisco/landing.png",
    screenshots: ["landing.png"],
    live: "", // User to provide
    github: "", // User to provide
    skills: {
      frontend: [
      ...
      return (
        <div>
          <TypographyP className="font-mono">
            ...
            Topics covered include Subnetting & Addressing and Network Protocols.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
        </div>
      );
